...
for epoch in range(n_epochs):
  ...
  ## get fitness ##
  sparsity_01 = cal_sparsity(params_01[0].data)
  sparsity_02 = cal_sparsity(params_02[0].data)
  sparsity_03 = cal_sparsity(params_03[0].data)
  sparsity_04 = cal_sparsity(params_04[0].data)
