...
# torch.FloatTensor(params_01[2].data.shape).uniform_() > 0.9
#torch.manual_seed(2)
mask_02 = torch.zeros((params_02[2].data.shape))
#torch.FloatTensor(params_02[2].data.shape).uniform_() > 0.9
#torch.manual_seed(3)
mask_03 = torch.zeros((params_03[2].data.shape))
#torch.FloatTensor(params_03[2].data.shape).uniform_() > 0.9
#torch.manual_seed(4)
mask_04 = torch.zeros((params_04[2].data.shape))
#torch.FloatTensor(params_04[2].data.shape).uniform_() > 0.9
#torch.manual_seed(5)
mask_05 = torch.zeros((params_05[2].data.shape))
#torch.FloatTensor(params_05[2].data.shape).uniform_() > 0.9
#torch.manual_seed(6)
mask_06 = torch.zeros((params_06[2].data.shape))
#torch.FloatTensor(params_06[2].data.shape).uniform_() > 0.9
#torch.manual_seed(7)
mask_07 = torch.zeros((params_07[2].data.shape))
#torch.FloatTensor(params_07[2].data.shape).uniform_() > 0.9
#torch.manual_seed(8)
mask_08 = torch.zeros((params_08[2].data.shape))
#torch.FloatTensor(params_08[2].data.shape).uniform_() > 0.9
