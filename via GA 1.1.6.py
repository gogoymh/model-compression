...
#### initial mask ####
torch.manual_seed(1)
mask_01 = torch.FloatTensor(params_01[2].data.shape).uniform_() > 0.11
torch.manual_seed(2)
mask_02 = torch.FloatTensor(params_02[2].data.shape).uniform_() > 0.22
torch.manual_seed(3)
mask_03 = torch.FloatTensor(params_03[2].data.shape).uniform_() > 0.33
torch.manual_seed(4)
mask_04 = torch.FloatTensor(params_04[2].data.shape).uniform_() > 0.44
torch.manual_seed(5)
mask_05 = torch.FloatTensor(params_05[2].data.shape).uniform_() > 0.55
torch.manual_seed(6)
mask_06 = torch.FloatTensor(params_06[2].data.shape).uniform_() > 0.66
torch.manual_seed(7)
mask_07 = torch.FloatTensor(params_07[2].data.shape).uniform_() > 0.77
torch.manual_seed(8)
mask_08 = torch.FloatTensor(params_08[2].data.shape).uniform_() > 0.88
...
for epoch in range(n_epochs):
  ...
  simple_mutate(copy[4],0.1)
  simple_mutate(copy[5],0.1)
  simple_mutate(copy[6],0.1)
  simple_mutate(copy[7],0.1)
