...
torch.manual_seed(5)
mask_05 = torch.FloatTensor(params_05[2].data.shape).uniform_() > 0.5
torch.manual_seed(6)
mask_06 = torch.FloatTensor(params_06[2].data.shape).uniform_() > 0.5
torch.manual_seed(7)
mask_07 = torch.FloatTensor(params_07[2].data.shape).uniform_() > 0.5
torch.manual_seed(8)
mask_08 = torch.FloatTensor(params_08[2].data.shape).uniform_() > 0.5
...
for epoch in range(n_epochs):
  ...
  #### record ####
  total_sparsity_01[epoch] = sparsity_01
  total_sparsity_02[epoch] = sparsity_02
  total_sparsity_03[epoch] = sparsity_03
  total_sparsity_04[epoch] = sparsity_04
  total_sparsity_05[epoch] = sparsity_05
  total_sparsity_06[epoch] = sparsity_06
  total_sparsity_07[epoch] = sparsity_07
  total_sparsity_08[epoch] = sparsity_08
