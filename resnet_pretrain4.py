        ...
        with torch.no_grad():
            ...
            if accuracy >= 0.932:
                torch.save({'epoch': epoch,
                            ...
                            'loss': losses[epoch].item()}, "C:/home/super/ymh/modelcomp/results/Resnet18_Cifar10_4.pkl")
                save_again = False
...
if save_again:
    torch.save({'epoch': epoch,
                'model_state_dict': model.state_dict(),
                'optimizer_state_dict': optimizer.state_dict(),
                'loss': losses[epoch].item()}, "/home/super/ymh/modelcomp/results/Resnet18_Cifar10_4.pkl")
    print("Saved")
