...
from utils import cal_sparsity, cal_ch, make_prob, cross_over, Mutate
...
class Main(object):
    ...
    def fine_tuning(self, epoch, fine):
        ...
        print("Fine tuning time is",(ft_stop-ft_start))
