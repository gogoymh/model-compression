...
parser.add_argument("--mask", type=float, default=0, help="Masking rate for sparsity tensor")
parser.add_argument("--mutate", type=float, default=0.001, help="Mutate probability")
parser.add_argument("--alpha", type=float, default=1, help="Ratio between loss and sparsity")
parser.add_argument("--buffer", type=int, default=250, help="Ratio between loss and sparsity")
...
print("Total epoch is %d" % (opt.n_epochs + opt.buffer))
alpha = opt.alpha
