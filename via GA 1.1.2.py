...
#### initial mask ####
torch.manual_seed(1)
mask_01 = torch.FloatTensor(params_01[2].data.shape).uniform_() > 0.2
torch.manual_seed(2)
mask_02 = torch.FloatTensor(params_02[2].data.shape).uniform_() > 0.4
torch.manual_seed(3)
mask_03 = torch.FloatTensor(params_03[2].data.shape).uniform_() > 0.6
torch.manual_seed(4)
mask_04 = torch.FloatTensor(params_04[2].data.shape).uniform_() > 0.8
