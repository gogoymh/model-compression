...
#### Custom Library #################################################################################################
from functions import load, cal_sparsity, minmax_sparsity, minmax_recip_loss, make_prob4, cross_over, Mutate
...
parser.add_argument("--buffer", type=int, default=250, help="Buffer for converge")
parser.add_argument("--recovery", type=float, default=0.01, help="Recovery constant")
parser.add_argument("--ensemble", type=int, default=4, help="Number of models")
