...
from network3 import resnet56
from Environment5 import Environment
from Agent6 import DDPG_Agent
...
parser.add_argument("--memory_size", type=int, default=30000, help="Memory size")
parser.add_argument("--warmup", type=int, default=500, help="Warm up episodes")
parser.add_argument("--lr", type=float, default=0.00005, help="Learning rate")
parser.add_argument("--episodes", type=int, default=12000, help="Total episodes")
...
################################################### Instanciate #################################################################
env = Environment(resnet56(num_classes=10), "C:/results/resnet56_real5.pth", test_loader, opt)
...
plot_FIFO = FIFO_plot_buffer(opt, len(env.prunable_layer))
