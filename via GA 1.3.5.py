...
#### initial mask ####
torch.manual_seed(1)
mask_01 = torch.FloatTensor(params_01[4].data.shape).uniform_() > 0.99
torch.manual_seed(2)
mask_02 = torch.FloatTensor(params_02[4].data.shape).uniform_() > 0.99
torch.manual_seed(3)
mask_03 = torch.FloatTensor(params_03[4].data.shape).uniform_() > 0.99
torch.manual_seed(4)
mask_04 = torch.FloatTensor(params_04[4].data.shape).uniform_() > 0.99
torch.manual_seed(5)
mask_05 = torch.FloatTensor(params_05[4].data.shape).uniform_() > 0.99
torch.manual_seed(6)
mask_06 = torch.FloatTensor(params_06[4].data.shape).uniform_() > 0.99
torch.manual_seed(7)
mask_07 = torch.FloatTensor(params_07[4].data.shape).uniform_() > 0.99
torch.manual_seed(8)
mask_08 = torch.FloatTensor(params_08[4].data.shape).uniform_() > 0.99
