...
class Environment:
    def __init__(self, model, path, test_loader, options):
        ...
        print('Length of Prunable layer is', len(self.prunable_layer))
    ...
    def get_reward(self, final_state):
        ...
        if accuracy > self.min_acc:
            ...
            acc_value = accuracy/(pruned_ratio + 1)
        
        reward = min(self.pruned_base, pruned_ratio) * min(acc_value, self.max_acc)
        
        return pruned_ratio, accuracy, reward
